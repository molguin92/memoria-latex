...
\note{%
    \begin{enumerate}
        \item Establecer el estado del arte;
        \item Identificar una solución viable;
        \item Diseñar la solución;
        \item Implementar el mecanismo;
        \item Validar su funcionamiento.
    \end{enumerate}
}
\end{frame}
...
\begin{figure}
    ...
    \label{fig:itsetsi}
\end{figure}
\note{ETSI: European Telecommunications Standards Institute}
\end{frame}
...
\note{%
    Efectos:
    \begin{itemize}
        \item comunicación -> transporte
        \item transporte -> comunicación
    \end{itemize}
}
\end{frame}
...
\end{enumerate}
\note{No existe solución que integre Paramics, brecha entre Comunicaciones y Transporte.}
\end{frame}
...
\note{
    \begin{itemize}
        \item \fullcite{sommer_german_dressler}
...
\note{%
    \fullcite{zuniga}
    Explicar bien escenario! (Accidente, comunicación)
}
\end{frame}

\begin{frame}[standout]
\centering
\movie[externalviewer]{Demo}{media/paramics3.webm}
\note{\movie[externalviewer]{Demo}{media/paramics3.webm}}
\end{frame}
...
\note{%
    \begin{itemize}
        \item Explicar Factor de Demanda.
        \item Comportamiento consistente para los 3 casos.
        \item Razones de diferencia casi ``despreciable'':
        \begin{enumerate}
            \item Accidente pequeño, escenario grande.
            \item Tiempo de simulación corto.
        \end{enumerate}
    \end{itemize}
}
\end{frame}
...
\note{%
    \begin{itemize}
        \item Gráfico de dispersión distancia vs tiempo.
        \item Notar ``ramas'' que presentan comportamiento anómalo.
    \end{itemize}
}
\end{frame}
...
\note{%
    \begin{itemize}
        \item Ser breve.
        \item Hablar de comportamiento exponencial - grafo!
        \item Explicar que al fin y al cabo igual es bueno.
    \end{itemize}
}
\end{frame}
...
\note{%
    ...
    \begin{minipage}{.8\textwidth}
        \begin{enumerate}
            \item Establecer el estado del arte;\hfill\checkmark
            \item Identificar una solución viable;\hfill\checkmark
            \item Diseñar la solución;\hfill\checkmark
            \item Implementar el mecanismo;\hfill\checkmark
            \item Validar su funcionamiento.\hfill\checkmark
        \end{enumerate}%
    \end{minipage}
}
...
\note{%
    \begin{itemize}
        \item Desafío: Software propietario.
        \item Salir de zona de ``confort'' en CS.
        \item Mencionar Paper!
    \end{itemize}
}
\end{frame}
...
\note{%
    \begin{itemize}
        \item Agradecer profes (todos, comisión y Cristián!)
        \item Agradecer familia y amigos.
        \item Preguntas?
    \end{itemize}
}
\end{frame}
