...
\begin{figure}[tpb]
    \lstinputlisting[style=myXML, label={cod:launchd_xml}, caption={Ejemplo de archivo XML de inicialización de la simulación.}]{codigo/paramics_example.launchd.xml}
\end{figure}
