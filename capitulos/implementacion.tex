...
\lstinputlisting[style=CPP, label={cod:traciserver_cmdgetvhcvar}, caption={Ejemplo de método de obtención y empaquetamiento de variables en \texttt{TraCIServer}}]{codigo/cmdGetVhcVar.cpp}
